...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "metadata" | "wellbore" | "perforations" | "history" | "custom_tools" | "employees"
  >("dashboard");
    ...
    >
      ...
      >
        <div className="flex flex-col flex-1">
          <div className="p-5 border-b border-slate-800/40 flex items-center gap-3.5 bg-[#0c1222]">
            <div className="p-2 bg-slate-900/90 border border-slate-800 rounded-xl shadow-md flex items-center justify-center shrink-0">
              <img src="/logo.svg" className="w-14 h-10 object-contain" alt="Logo" />
            </div>
            <div>
      ...
      <div className="flex-1 flex flex-col min-w-0 md:h-full md:overflow-hidden" id="main_content_wrapper">
        ...
        {activeWell ? (
          <main className="flex-1 p-6 space-y-6 overflow-y-auto" id="app_main_content">
            ...
            {activeTab !== "dashboard" && activeTab !== "custom_tools" && activeTab !== "employees" && (
            ...
            <div className={activeTab === "dashboard" || activeTab === "history" || activeTab === "custom_tools" || activeTab === "employees" ? "w-full" : "grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch w-full"}>
              {/* Left Column: Form Editors */}
              <section className={activeTab === "dashboard" || activeTab === "history" || activeTab === "custom_tools" || activeTab === "employees" ? "w-full" : "lg:col-span-7 xl:col-span-7 min-w-0 flex flex-col"} id="left_form_workspace">
              ...
              {activeTab !== "dashboard" && activeTab !== "history" && activeTab !== "custom_tools" && activeTab !== "employees" && (
